...
function Books() {
  ...
  //   {
  //     id: 1,
  //     bookName: "Wie ein Vogel",
  //     url: "https://i.postimg.cc/bYF4CzHt/Mask-group-1.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //     language: "Alemão",
  ...
  //     url: "https://i.postimg.cc/YCqGrKsM/Mask-group-2.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  ...
  //     id: 4,
  //     bookName: "White Bird",
  //     url: "https://i.postimg.cc/bJpT5jCN/Mask-group-6.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  ...
  //     url: "https://i.postimg.cc/HkPnK06J/Mask-group-7.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 6,
  //     bookName: "Harry Potter und der Feuerkelch",
  //     url: "https://i.postimg.cc/mrJwbHgk/Mask-group-8.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 7,
  //     bookName: "Harry Potter e o Cálice de Fogo",
  //     url: "https://i.postimg.cc/Z5CJMVV1/Mask-group-10.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 8,
  //     bookName: "O Labirinto dos Ossos",
  //     url: "https://i.postimg.cc/4y9ScH52/Mask-group-11.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 9,
  //     bookName: "Das Labyrinth der Knochen",
  //     url: "https://i.postimg.cc/fyt6vrwK/Mask-group-12.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 10,
  //     bookName: "Fuga - Série Ilha",
  //     url: "https://i.postimg.cc/ZKyW9Yh9/Mask-group-13.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 11,
  //     bookName: "Pássaro Branco",
  //     url: "https://i.postimg.cc/MTPYGZJP/Mask-group-14.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 12,
  //     bookName: "O Ladrão de Raios",
  //     url: "https://i.postimg.cc/g2tRRSTj/Mask-group-15.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 13,
  //     bookName: "Le Voleur de foudre",
  //     url: "https://i.postimg.cc/8CT3JCxN/Mask-group-16.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
  //   {
  //     id: 14,
  //     bookName: "Island - Book Three: Escape",
  //     url: "https://i.postimg.cc/SRsmmGpM/Mask-group-4.png",
  //     price: 10,
  //     rating: 0,
  //     amountOfPages: 147,
  //   },
